...
self.addEventListener('push', (event) => {
  const options = {
    body: event.data ? event.data.text() : 'New daily challenges are available!',
...
self.addEventListener('notificationclick', (event) => {
  ...
  if (event.action === 'explore') {
    event.waitUntil(
      clients.openWindow('/?notification=daily-challenge')
    );
  }
});

// Placeholder function for syncing game progress
